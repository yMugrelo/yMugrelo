...
# Olá! Eu sou o Murilo 
 ...
 Focado em **Java, Backend, Algoritmos e Estruturas de Dados**
 Construindo minha base para atuar com **Machine Learning**

Atualmente estou fortalecendo meus fundamentos de programação através de projetos, resolução de problemas e desenvolvimento de aplicações.

Meu objetivo é construir uma base sólida em **Software Engineering** e, posteriormente, aplicar esses conhecimentos em sistemas de **Machine Learning em produção**.
...
Sistema de recomendação de filmes utilizando **Python, TF-IDF, FastAPI e Streamlit**.

🔗 [Ver projeto](https://github.com/yMugrelo/Movie_Re)
...
🔗 [Ver repositório](https://github.com/yMugrelo)
...
<a href="https://www.linkedin.com/in/murilo-rosa-de-paula-b802a0279/">
